...
--10
SELECT FirstName+ ' '+MiddleName+' ' +LastName AS 'Full Name' FROM Employees WHERE (Salary = 25000 OR Salary = 14000 OR Salary = 23600 OR Salary = 12500)
...
SELECT FirstName + ' '+ COALESCE(MiddleName,'') + ' ' + LastName AS 'Full Name', JobTitle FROM Employees
